...
export default function SampleIssuedBookItem() {
  return (
    <TouchableOpacity style={styles.container} onPress={() => {}}>
      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.dateContainer}>
          ...
          <Text style={styles.time}>John Doe</Text>
        </View>
        ...
        <View style={styles.dateContainer}>
          ...
          />
          <Text style={{...styles.time, color: Theme.colors.onErrorContainer}}>
            Due at at 5 June, 2022
          </Text>
        </View>
      </View>
    </TouchableOpacity>
